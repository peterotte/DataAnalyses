...
//const char Str_RootFilesButResults[] = "/datapool/2010_09_pi0/output/sum/sumButSep.root"; 
//const char Str_RootFilesButResults[] = "/datapool/2011_02_pi0/output/sum/sumButFeb.root"; 
...
void SubBackgroundBut() {
	...
	h2TempP = (TH2D*)gROOT->FindObject("MissingMassCombinedSignalLTCorrectedP");
	h2TempM = (TH2D*)gROOT->FindObject("MissingMassCombinedSignalLTCorrectedM");
