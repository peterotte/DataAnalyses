...
const char Str_RootFilesButOutput[] = "output/sumBut1TaggChUsed.root"; 
...
//	gROOT->cd();
	...
	CopyElement("MissingMassCombinedSignalLTCorrectedFP");
...
//		h2->SetBinContent(i, AnpassungAnWert );
	}
	h2->Write();
