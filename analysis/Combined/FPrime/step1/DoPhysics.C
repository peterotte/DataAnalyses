...
void DoPhysics() {
	...
	h2TempP = (TH2D*)gROOT->FindObject("MissingMassCombinedSignalLTCorrectedFPrimeP");
	h2TempM = (TH2D*)gROOT->FindObject("MissingMassCombinedSignalLTCorrectedFPrimeM");
	TH2D *h2TargetPol = (TH2D*)gROOT->FindObject("TargetPolFPrime");
